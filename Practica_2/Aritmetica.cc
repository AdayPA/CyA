...
// Fecha: 07/10/2020
// Archivo Aritmetica:   Contiene la clase Aritmetica, el cual aplica el algoritmo
//                       de Eratóstenes para hallar los numeros primos.
...
Aritmetica::Aritmetica(int numPrimos) {
  //Iniciamos el vector de booleanos, con todos los valores a true por defecto.
...
void Aritmetica::imprimir(void) {
  //Imprimimos los números primos, que son los que tiene el valor true en el vector booleano.
...
void Aritmetica::siege(void) {
  //Marca los no primos de la lista hasta raiz de n (el valor que se le ingresa por consola)
  //e invoca a la función remove. Para mas detalle observar el pseudocódigo de las referencias.
